...
//  DataStructures
//
//  Created by Heaps, Dane on 4/17/18.
...
template <class Type>
BinaryTreeNode<Type> * AVLTree<Type> :: balanceSubTree (BinaryTreeSearch<Type> * parent)
{
...
template <class Type>
BinaryTreeNode<Type> * AVLTree :: insertNode(BinaryTreeNode<Type> * parent, Type inserted)
{
    if(parent == nullptr)
    {
...
{
    insertNode(his->getRoot(), item);
}

template <class Type>
void AVLTree<Type> :: remov(Type item)
{
